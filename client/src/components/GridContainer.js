...
import { getDepartmentsQuery, deleteDepartmentMutation } from '../queries/queries'
import {flowRight as compose} from 'lodash'
// import MyCommandCell from './MyCommandCell'

const GridContainer = ({ changeRowSelection, addItem, inEdit, getDepartments, deleteDepartmentMutation }) => {
      ...
      return (
          <td colSpan={props.colSpan} style={props.style}>
            <button
              ...
              onClick={(e) => window.confirm('Confirm deleting: ' + props.dataItem.title) && remove(props.dataItem)}>
              Remove
            </button>
          </td>
      );
  ...
  return (
    <div>
      <Grid data={getDepartments.loading === true ? [] : getDepartments.departments}>
